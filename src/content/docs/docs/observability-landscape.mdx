...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    src={otelCollector.src}
    style="width: 100%"
  />
  <h4>Components of an OpenTelemetry Collector</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; max-width: 100%; margin: 1rem 6rem;">
  <img
    src={prometheus.src}
    style="width: 100%"
  />
  <h4>Prometheus instance scraping from multiple services and storing data</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; max-width: 100%; margin: 2rem 4rem;">
  <img
    src={ossPlatforms.src}
    style="width: 100%"
  />
  <h4>Landscape of open-source observability tools by role in a telemetry pipeline</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    ...
    style="width: 100%"
  />
  <h4>An example of a DIY observability platform</h4>
</figure>
