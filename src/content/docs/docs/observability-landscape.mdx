...
import otelCollector from '../../../assets/diagrams/Otel-Collector.svg?raw';
import prometheus from '../../../assets/diagrams/Prometheus.svg?raw';
import ossPlatforms from '../../../assets/diagrams/OSS-Platforms.svg?raw';
import ossScenario from '../../../assets/diagrams/OSS-Scenario.svg?raw';
...
<figure style="display: flex; justify-content: center; margin: 11rem; max-width: 100%;">
  <div set:html={otelCollector} style="transform: scale(2); max-width: 60%; transform-origin: center;" />
</figure>
...
<figure style="display: flex; justify-content: center; margin: 16rem; max-width: 100%;">
  <div set:html={prometheus} style="transform: scale(2); max-width: 80%; transform-origin: center;" />
</figure>
...
<figure style="display: flex; justify-content: center; margin: 11rem; max-width: 100%;">
  <div set:html={ossPlatforms} style="transform: scale(2); max-width: 60%; transform-origin: center;" />
</figure>
...
<figure style="display: flex; justify-content: center; margin: 11rem; max-width: 100%;">
  <div set:html={ossScenario} style="transform: scale(2); max-width: 60%; transform-origin: center;" />
</figure>
