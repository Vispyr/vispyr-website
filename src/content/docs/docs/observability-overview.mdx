...
<figure class="example" style="display: flex; flex-direction: column; justify-content: center;">
  <img
    src={metricsExample.src}
    style="width: 100%"
  />
  <h4>Two examples of system metrics</h4>
</figure>
...
<figure class="example" style="display: flex; flex-direction: column; justify-content: center;">
  <img
    ...
    style="width: 100%"
  />
  <h4>A trace waterfall showing multiple spans for a single trace</h4>
</figure>
...
<figure class="example" style="display: flex; flex-direction: column; justify-content: center;">
  <img
    ...
    style="width: 100%"
  />
  <h4>Output from logging, demonstrating the challenge of searching logs to perform a root cause analysis</h4>
</figure>
...
<figure class="example" style="display: flex; flex-direction: column; justify-content: center;">
  <img
    ...
    style="width: 100%"
  />
  <h4>A flame graph showing the relative time the CPU spent on each function</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 1rem 4rem;">
  <img
    src={observabilityPlatform.src}
    style="width: 100%"
  />
  <h4>The four components of an observability platform</h4>
</figure>
...
<ThemedImage
  src="Telemetry-Pipeline.svg"
  alt="The telemetry pipeline"
  caption="A telemetry pipeline connecting instrumented applications to data storage"
/>
...
<ThemedImage
  src="Data-Storage.svg"
  alt="The telemetry data storage options"
  caption="A telemetry pipeline connecting to four distinct data stores, one for each telemetry signal"
/>
...
<figure class="example" style="display: flex; flex-direction: column; justify-content: center">
  ...
  <h4>An interactive dashboard visualizing multiple telemetry signals</h4>
</figure>
