...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    ...
    style="width: 100%"
  />
  <h4>A telemetry pipeline connecting instrumented applications to data storage</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    ...
    style="width: 100%"
  />
  <h4>A telemetry pipeline connecting to four distinct data stores, one for each telemetry signal</h4>
</figure>
