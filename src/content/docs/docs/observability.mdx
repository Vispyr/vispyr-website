...
import observabilityPlatform from '../../../assets/diagrams/Observability-Platform.svg?raw';
import telemetryPipeline from '../../../assets/diagrams/Telemetry-Pipeline.svg?raw';
import metricStorage from '../../../assets/diagrams/Metric-Storage.svg?raw';
...
<figure style="display: flex; justify-content: center; margin: 4rem;">
  <img src={metricsExample.src} />
</figure>
...
<figure style="display: flex; justify-content: center; margin: 4rem; max-width: 100%;">
  <div set:html={observabilityPlatform} style="transform: scale(2); max-width: 60%; transform-origin: center;" />
</figure>
...
<figure style="display: flex; justify-content: center; margin: 11rem; max-width: 100%;">
  <div set:html={telemetryPipeline} style="transform: scale(2); max-width: 60%; transform-origin: center;" />
</figure>
...
<figure style="display: flex; justify-content: center; margin: 11rem; max-width: 100%;">
  <div set:html={metricStorage} style="transform: scale(2); max-width: 60%; transform-origin: center;" />
</figure>
