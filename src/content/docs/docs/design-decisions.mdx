...
<ThemedImage
  src="Collector-Comparison-Otel.svg"
  alt="Collector Comparison - Otel"
  caption="Telemetry pipeline with profiles bypassing the OTel Agent and Gateway Collectors"
/>
...
<ThemedImage
  src="Collector-Comparison-Alloy.svg"
  alt="Collector Comparison - Alloy"
  caption="Telemetry pipeline with the Alloy Agent and Gateway Collectors processing profiles with all telemetry data"
/>
...
<ThemedImage
  src="Pyro-vs-Parca.svg"
  alt="Pyroscope vs Parca"
  caption="Pyroscope vs Parca"
/>
...
<ThemedImage
  src="Mimir-vs-Prom.svg"
  alt="Mimir vs Prometheus"
  caption="Mimir vs Prometheus"
/>
...
<ThemedImage
  src="Tempo-vs-Jaeger.svg"
  alt="Tempo vs Jaeger"
  caption="Tempo vs Jaeger"
/>
...
<ThemedImage
  src="Infrastructure-Choice.svg"
  alt="EC2 vs ECS"
  caption="Infrastructure decision between EC2 or ECS + Fargate deployment"
/>
