...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    ...
    style="width: 100%"
  />
  <h4>Telemetry pipeline with profiles bypassing the OTel Agent and Gateway Collectors</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    ...
    style="width: 100%"
  />
  <h4>Telemetry pipeline with the Alloy Agent and Gateway Collectors processing profiles with all telemetry data</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: -1rem 6rem -4rem">
  <img
    src={pyroVsParca.src}
    style="width: 100%"
  />
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 1rem 6rem;">
  <img
    src={mimirVsProm.src}
    style="width: 100%"
  />
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    ...
    style="width: 100%"
  />
  <h4>Infrastructure decision between EC2 or ECS + Fargate deployment</h4>
</figure>
