...
import vispyrInfrastructure from '../../../assets/diagrams/Vispyr-Infrastructure.svg?raw';
import vispyrBackend from '../../../assets/diagrams/Vispyr-Backend.svg?raw';
import vispyrAgent from '../../../assets/diagrams/Vispyr-Agent.svg?raw';
...
<figure style="display: flex; justify-content: center; margin: 4rem;">
  <div set:html={vispyrInfrastructure} />
</figure>
