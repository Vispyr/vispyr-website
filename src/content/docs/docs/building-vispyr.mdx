...
import vendorComparison from '../../../assets/versus/Vendor-Comparison.svg';
import vispyrInfrastructure from '../../../assets/diagrams/Vispyr-Infrastructure.svg';
import vispyrBackend from '../../../assets/diagrams/Vispyr-Backend.svg';
import vispyrAgent from '../../../assets/diagrams/Vispyr-Agent.svg';
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 10rem;">
  <img
    src={vendorComparison.src}
    style="width: 100%"
  />
  <h4>Vispyr compared to the landscape of observability platforms</h4>
</figure>
...
<Picture src={vispyrInfrastructure} alt="Vispyr Infrastructure" />

<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 4rem;">
  <img
    src={vispyrInfrastructure.src}
    style="width: 100%"
  />
  <h4>The full Vispyr architecture</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 5%;">
  <img
    src={vispyrBackend.src}
    style="width: 100%"
  />
  <h4>The Vispyr Backend architecture</h4>
</figure>
...
<figure style="display: flex; flex-direction: column; justify-content: center; margin: 2rem 15%;">
  <img
    src={vispyrAgent.src}
    style="width: 100%"
  />
  <h4>The Vispyr Agent architecture</h4>
</figure>
